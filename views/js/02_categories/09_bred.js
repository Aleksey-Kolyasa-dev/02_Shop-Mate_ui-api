...
Object.defineProperty(bred, "createNewItem", { enumerable: false } ); 


bred.createNewItem("xItem76", " ", 0.00, "09_brd_76.jpg", "пчк");
bred.createNewItem("xItem75", " ", 0.00, "09_brd_75.jpg", "бнк");
bred.createNewItem("xItem74", " ", 0.00, "09_brd_74.jpg", "шт");




bred.createNewItem("lavash", "Лаваш", 8.00, "09_brd_03_lavash_10_pch.jpg", "пчк");
bred.createNewItem("hlebBlack", "Хлеб Темный", 7.00, "09_brd_02_hleb_cherniy_7_sht.jpg", "бтн");
bred.createNewItem("hlebWhite", "Хлеб Белый", 8.00, "09_brd_01_hleb_beliy_8_sht.jpg", "бтн");
												...
												for ( key in bred) {
													...
													var imgString = bred[key].toString(); // get String from item-img-name to operate with it
														...
														'<div class="row">'+ 
															'<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12  item-up">'+
																 ...
																 '<div class="col-xs-8 col-sm-8 col-md-8 col-lg-10 img-block ">'+		// src='' to img
																	'<img class="img-circle img-thumbnail item-img" src="images/09_brd/'+bred[key].img+'" alt="'+alt+'" title="' + bred[key].name + '" atr="'+bred[key].price +'" />'+
																 '</div>'+
														...
														'<div class="row">'+
															'<div class="col-xs-12 col-sm-12  col-md-12 col-lg-12 item-down   text-center">'+
															  ...
															  '<div class="col-xs-3 col-sm-4  col-md-4 col-lg-4 text-center units-block ">'+
																...
																'<span class=""> '+bred[key].units +' </span>'+
															  '</div>'+		  	 
